...
import { View, ScrollView, Text, StyleSheet, TextInput, Dimensions, ImageBackground, TouchableOpacity, Image } from 'react-native';
import Carousel from 'react-native-snap-carousel';
import Icon from 'react-native-vector-icons/MaterialIcons';


const {width: screeWidth , height: screenHeight} = Dimensions.get('window');
     ...
     <View style={{flex: 1, height: screenHeight}}>
        <View style={{...StyleSheet.absoluteFill, backgroundColor: '#000'}}> 
            <ImageBackground source={{uri: background}} style={styles.imgBg} blurRadius={8}>
              ...
              <Text style={{color: '#fff', fontSize: 28, fontWeight: "bold", marginLeft:10, marginVertical: 10,}}>
                Acabou de chegar
              </Text>
              ...
              <View style={styles.moreInfo} >
                  ...
                  <TouchableOpacity style={{marginRight: 15, marginTop:10}} onPress={()=> alert(lista[activeIndex].title)}>

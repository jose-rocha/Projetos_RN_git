...
const hourAtual = new Date().getHours();
const minutesAtual =  new Date().getMinutes();
...
export default class HomeItem extends Component {
    ...
    render() {
        ...
        <div className="container-fluid p-0" id="fixa">
         ...
         <h4 className="spItens">Hoje é: {dateAtual} e {hourAtual}:{minutesAtual} hrs </h4>
                                  
                                    {/*Esse Button é o menu Humburger ao diminuir a tela */}
                ...
                <div className="fixed"  >
                    <div className="link1"> 
                        <Link  to="/dashboard"    >
                            ...
                            <AiOutlineDashboard color="#131313" size="22px" /> 
                    ...
                    <div className="link1" >
                        <Link  to="/Itens"   >
                        <div className="navbar-brand">
                            <FaCubes color="#131313" size="15px" /> 
                    ...
                    <div className="link1" >
                        <Link  to="/OS"   >
                        <div className="navbar-brand">
                            <AiFillFileText color="#131313" size="15px" /> 
                    ...
                    <div className="link1" >
                        <Link  to="/tarefas"   >
                        <div className="navbar-brand">
                            <FaWrench color="#131313" size="15px" /> 
                    ...
                    <div className="link1" >
                        <Link  to="/chamados"   >
                        <div className="navbar-brand">
                            <FaExclamationCircle color="#131313" size="15px" /> 
                    ...
                    <div className="link1" >
                        ...
                        <div className="navbar-brand">
                            <AiFillSetting color="#131313" size="15px" /> 
...
{   /*     {this.state.ativos.map((ativo) =>{
          ...
          <table className="table" >
                          ...
                          <tr className="tr1" >
                            ...
                            <th> <input type="search" placeholder="pesquisar" /> </th>
                            <th></th>
                            <th></th>
                            <th className="thAtivos">   
               ...
               {this.state.ativos.map((ativo) =>{
                   return(
                    <tr key={ativo.key} className="trAtivos">
                        ...
                        <td><Link to={`../Local/${ativo.localizacao}`} >AVENIDA TAL</Link></td>
                        <td> CODE</td>
                        <td>---</td>
                        <td>0 </td>
